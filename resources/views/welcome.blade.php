...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Welcome to Blogposts</title>
            ...
            @endif
                {{-- <div>List of Blogs</div>
                    @foreach ($blogs as $blogs)
                        <div class="border-gray-700 max-w-5xl mx-auto">
                            <form action="/home" class="flex space-x-2" method="GET"> 
                            <input type="text" name="content" value="{{ $blogs->content }}" class="bg-white py-2 px-4 rounded-full text-black">
                            {{-- <button type="submit" class="bg-blue-300 text-red-900 py-3 px-4 rounded-full">Edit</button> --}}
                            {{-- </form>
                        </div>
                    @endforeach --}} 
                    {{-- <div>
                        <div>List of Blogs for /</div>
                            @foreach ($blogs as $blogs)
                                <div class="border-gray-700 max-w-5xl mx-auto">
                                    <form action="/" class="flex space-x-2" method="GET"> 
                                    <input type="text" name="content" value="{{ $blogs->content }}" class="bg-white py-2 px-4 rounded-full text-black">
                                    {{-- <button type="submit" class="bg-blue-300 text-red-900 py-3 px-4 rounded-full">Edit</button> --}}
                                    {{-- </form>
                                </div>
